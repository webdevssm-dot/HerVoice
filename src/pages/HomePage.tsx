    ...
    <div className="space-y-20 pb-16">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
              ...
              <p className="text-base sm:text-lg text-[#604868] dark:text-[#d2b8cf] max-w-xl mx-auto lg:mx-0 leading-relaxed font-medium">
            ...
            <div className="lg:col-span-5 relative flex justify-center">
              <div className="relative rounded-2xl sm:rounded-[2.5rem] bg-white dark:bg-[#1e0f1d] p-2 sm:p-3 shadow-2xl border border-pink-100/60 dark:border-[#381f35] rotate-2 transform hover:rotate-0 transition-transform duration-300 max-w-md w-full">
                ...
                <div className="absolute -bottom-2.5 -left-2.5 sm:-bottom-4 sm:-left-4 bg-[#0096cc] text-white p-2.5 sm:p-4 rounded-xl sm:rounded-2xl shadow-xl flex flex-col max-w-[150px] sm:max-w-[200px]">
                  <span className="text-lg sm:text-2xl font-black leading-none">10k+</span>
                  <span className="text-[9px] sm:text-[11px] font-bold mt-1 leading-tight text-white/90">Sisters connected across the nation</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-2xl mx-auto mb-8 sm:mb-12 space-y-2">
          <h2 className="text-2xl sm:text-3xl font-black text-[#2e1a28] dark:text-[#f8f0f7]">Everything You Need to Rise & Lead</h2>
          <p className="text-xs sm:text-sm text-[#604868] dark:text-[#d2b8cf]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3.5 sm:gap-8">
          ...
          <div
            onClick={() => setActiveTab('rights')}
            className="p-4 sm:p-8 bg-white dark:bg-[#1e0f1d] rounded-2xl sm:rounded-3xl border border-[#f2e8f2] dark:border-[#381f35] hover:shadow-xl transition-all hover:-translate-y-1 cursor-pointer group flex flex-col justify-between space-y-3 sm:space-y-6"
          >
            <div className="space-y-2.5 sm:space-y-4">
              <div className="w-9 h-9 sm:w-12 sm:h-12 rounded-xl sm:rounded-2xl bg-[#fce8f5] dark:bg-[#341832] text-[#e040a0] dark:text-[#f25cb8] flex items-center justify-center">
                <span className="material-symbols-outlined text-lg sm:text-2xl font-bold">gavel</span>
              </div>
              <h3 className="text-base sm:text-xl font-black text-[#2e1a28] dark:text-[#f8f0f7]">Know Your Rights</h3>
              <p className="text-xs sm:text-sm text-[#604868] dark:text-[#d2b8cf] leading-relaxed">
                Understand constitutional protections, domestic safety laws, and free helpline options in easy, everyday terms.
              </p>
            </div>
          ...
          >
            <div className="space-y-2.5 sm:space-y-4">
              <div className="w-9 h-9 sm:w-12 sm:h-12 rounded-xl sm:rounded-2xl bg-[#f0e5ff] dark:bg-[#2b172a] text-[#7c52aa] dark:text-[#b08cc9] flex items-center justify-center">
                <span className="material-symbols-outlined text-lg sm:text-2xl font-bold">auto_awesome</span>
              </div>
              <h3 className="text-base sm:text-xl font-black text-[#2e1a28] dark:text-[#f8f0f7]">Discover Mentors</h3>
              <p className="text-xs sm:text-sm text-[#604868] dark:text-[#d2b8cf] leading-relaxed">
                Read inspiring stories of Batswana women breaking barriers in tech, law, arts, agriculture, and community leadership.
              </p>
            </div>
          ...
          >
            <div className="space-y-2.5 sm:space-y-4">
              <div className="w-9 h-9 sm:w-12 sm:h-12 rounded-xl sm:rounded-2xl bg-[#e0f2fe] dark:bg-[#152a38] text-[#0096cc] dark:text-[#38bdf8] flex items-center justify-center">
                <span className="material-symbols-outlined text-lg sm:text-2xl font-bold">rocket_launch</span>
              </div>
              <h3 className="text-base sm:text-xl font-black text-[#2e1a28] dark:text-[#f8f0f7]">Bring Dreams to Life</h3>
              <p className="text-xs sm:text-sm text-[#604868] dark:text-[#d2b8cf] leading-relaxed">
                Share your personal goals, propose local youth initiatives, and connect with fellow changemakers across Botswana.
              </p>
            </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6">
          ...
          >
            <div className="h-32 sm:h-64 overflow-hidden relative">
              ...
              />
              <span className="absolute top-2 left-2 sm:top-3 sm:left-3 px-2 py-0.5 sm:px-3 sm:py-1 bg-[#e040a0] text-white text-[8px] sm:text-[10px] font-bold rounded-full uppercase">
                INNOVATION
              </span>
            </div>
            <div className="p-3 sm:p-5 flex-1 flex flex-col justify-between space-y-1.5 sm:space-y-2">
              <h3 className="font-bold text-xs sm:text-base text-[#2e1a28] dark:text-[#f8f0f7] group-hover:text-[#e040a0] dark:group-hover:text-[#f25cb8] transition-colors">
                Pioneering Tech in Gaborone
              </h3>
              <p className="text-[11px] sm:text-xs text-[#604868] dark:text-[#d2b8cf] line-clamp-2">
          ...
          >
            <div className="h-32 sm:h-64 overflow-hidden relative">
              <img
                ...
                className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300"
              />
              <span className="absolute top-2 left-2 sm:top-3 sm:left-3 px-2 py-0.5 sm:px-3 sm:py-1 bg-[#7c52aa] text-white text-[8px] sm:text-[10px] font-bold rounded-full uppercase">
                LEADERSHIP
              </span>
            </div>
            <div className="p-3 sm:p-5 flex-1 flex flex-col justify-between space-y-1.5 sm:space-y-2">
              <h3 className="font-bold text-xs sm:text-base text-[#2e1a28] dark:text-[#f8f0f7] group-hover:text-[#7c52aa] dark:group-hover:text-[#b08cc9] transition-colors">
          ...
          >
            <div className="h-32 sm:h-64 overflow-hidden relative">
              <img
                ...
                className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300"
              />
              <span className="absolute top-2 left-2 sm:top-3 sm:left-3 px-2 py-0.5 sm:px-3 sm:py-1 bg-[#0096cc] text-white text-[8px] sm:text-[10px] font-bold rounded-full uppercase">
                ART & CULTURE
              </span>
            </div>
            <div className="p-3 sm:p-5 flex-1 flex flex-col justify-between space-y-1.5 sm:space-y-2">
              <h3 className="font-bold text-xs sm:text-base text-[#2e1a28] dark:text-[#f8f0f7] group-hover:text-[#0096cc] dark:group-hover:text-[#38bdf8] transition-colors">
                Canvas for Change
              </h3>
              <p className="text-[11px] sm:text-xs text-[#604868] dark:text-[#d2b8cf] line-clamp-2">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-gradient-to-r from-[#fce8f5] via-[#f8e8f8] to-[#f0e5ff] dark:from-[#2a1329] dark:via-[#221021] dark:to-[#1e1026] p-6 sm:p-14 rounded-2xl sm:rounded-3xl text-[#2e1a28] dark:text-[#f8f0f7] text-center shadow-lg border border-pink-200/80 dark:border-[#3d233c] space-y-4 sm:space-y-6 relative overflow-hidden">
          ...
          <p className="text-sm sm:text-base text-[#604868] dark:text-[#d2b8cf] max-w-xl mx-auto font-medium leading-relaxed">
