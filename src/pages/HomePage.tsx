          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-5 relative flex justify-center">
              <div className="relative rounded-[2.5rem] bg-white p-3 shadow-2xl border border-pink-100/60 rotate-2 transform hover:rotate-0 transition-transform duration-300 max-w-md w-full">
                ...
                <div className="absolute -bottom-4 -left-4 bg-[#0096cc] text-white p-4 rounded-2xl shadow-xl flex flex-col max-w-[200px]">
                  <span className="text-2xl font-black leading-none">10k+</span>
                  <span className="text-[11px] font-bold mt-1 leading-tight text-white/90">Sisters connected across the nation</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          >
            <div className="h-64 overflow-hidden relative">
              ...
              />
              <span className="absolute top-3 left-3 px-3 py-1 bg-[#e040a0] text-white text-[10px] font-bold rounded-full uppercase">
                INNOVATION
              </span>
            </div>
          ...
          >
            <div className="h-64 overflow-hidden relative">
              <img
                ...
                className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300"
              />
              <span className="absolute top-3 left-3 px-3 py-1 bg-[#0096cc] text-white text-[10px] font-bold rounded-full uppercase">
                ART & CULTURE
              </span>
            </div>
            <div className="p-5 flex-1 flex flex-col justify-between space-y-2">
